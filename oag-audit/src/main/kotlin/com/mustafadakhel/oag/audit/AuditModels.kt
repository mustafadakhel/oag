...
data class AuditContentInspection(
    ...
    @SerialName("escalation_pattern") val escalationPattern: String? = null,
    @SerialName("escalation_window_scores") val escalationWindowScores: List<Double>? = null,
    @SerialName("escalation_window_size") val escalationWindowSize: Int? = null,
